...
public class DicionarioMetodos 
{
	...
	public static void populaChaves( )
	{
		...
		CHAVES.put( 9 , "setDependenciaPNE" );
		...
		CHAVES.put( 20 , "setRegimeFundamental" );
		CHAVES.put( 21 , "setRegimeMedioNormal" );
		CHAVES.put( 22 , "setRegimeMedioIntegrado" );
		CHAVES.put( 23 , "setRegimeMedioMedio" );
		...
		CHAVES.put( 44 , "isDependenciaPNE" );
